# https://github.com/Gymat/SurfelNeRF/blob/unofficial/data/pre_surfel_scannet/prepare_part1.py
import json
import os
import argparse
...
def main(args):
    ...
    for sid in tqdm(range(num_total), desc=l_name[sid]):
        ...
        with open(os.path.join(args.output_dict, "transforms.json"), "w") as outfile:
