# ref: https://github.com/Gymat/SurfelNeRF/blob/unofficial/data/download-scannet.py
#!/usr/bin/env python
...
def main():
    ...
    parser.add_argument('--subset', action='store_true', help='download training ScanNet scenes only')
